...
data_path = "test_results/14_02_22_5/" #"test_results/19_10_20A_20B_unrolled_GPU/" # 08_10_one_hot_3_CPU_20A_20B
test_file = [data_path + "test/20A_20B.csv"]
#test_file = [data_path + "test_20B/combined_dataframe.csv"] # combined dataframe for 20B (as X) and children of 20B (as Y)
...
def get_path_all_gen_files(path=data_path + "gen_file"):    
